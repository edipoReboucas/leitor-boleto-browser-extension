...
exports.identificarData = (codigo, tipoCodigo) => {
 ...
 const fatorData = exports.obtemFatorData({ codigo, tipoCodigo })
...
exports.identificarDataComNovoFator2025 = (codigo, tipoCodigo) => {
 ...
 let fatorData = exports.obtemFatorData({ codigo, tipoCodigo });
...
exports.validarCodigoComDV = (codigo, tipoCodigo) => {
 ...
 //console.log(dv1)
 //console.log(exports.calculaMod11(bloco1))
 //console.log(dv2)
 //console.log(exports.calculaMod11(bloco2))
 //console.log(dv3)
 //console.log(exports.calculaMod11(bloco3))
 //console.log(dv4)
 //console.log(exports.calculaMod11(bloco4))

 let valid = (exports.calculaMod11(bloco1) == dv1 &&
 exports.calculaMod11(bloco2) == dv2 &&
 exports.calculaMod11(bloco3) == dv3 &&
 exports.calculaMod11(bloco4) == dv4)
 ...
 tipoBoleto = exports.identificarTipoBoleto(codigo);
 ...
 */
 ...
 } else if (!exports.validarCodigoComDV(codigo, tipoCodigo)) {
 retorno.sucesso = false;
 retorno.codigoInput = codigo;
 ...
 retorno.vencimentoComNovoFator2025 = exports.identificarDataComNovoFator2025(codigo, 'LINHA_DIGITAVEL');
 ...
 retorno.vencimentoComNovoFator2025 = exports.identificarDataComNovoFator2025(codigo, 'CODIGO_DE_BARRAS');
